...
(function registerRoofrApiGateway() {
  ...
  const handlers = {
    ...
    ROOFR_API_GET_JOB_TASKS: (msg) => window.RoofrApi.getJobTasks(msg.jobId),
    ROOFR_API_SET_TASK_STATUS: (msg) => window.RoofrApi.setTaskStatus(msg.jobId, msg.taskId, msg.status),
